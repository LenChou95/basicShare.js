...
(function($, window, document) {
    ...
    $.fn.basicShare = function() {
        ...
        var imgPath = "https://cdn.qinco.net/basicShare/img",
            imgPreload = [
                               ...
                               +"<div style='display:table;width:100%;'>"
                                 +"<div style='float:left;width:100%;'>"
                                   ...
                                   +"<div style='margin:auto;width:50%;text-align:center;min-height:200px;'>"
                                       +"<img alt='二维码加载中...' src='https://api.qinco.net/api/qr?size=400&content="+encodeURIComponent(shareUrl)+"' style='width:100%;max-width:300px;height: auto;' />"
                                   +"</div>"
